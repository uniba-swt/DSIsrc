...
{ 
  ...
  logBlockEntry("cell-sll.c", 34);
  head = & node01.Link01;
  logAssignNoOffset("cell-sll.c", 34, & head, "struct Linkage_Struct *", "head", head,
                    "struct Linkage_Struct", "& node01.Link01", 0);
  node01.Link01.Next = & node01.Link02;
  logAssignOffset("cell-sll.c", 36, & node01, "struct Weiss_SLL_Node", "node01", & node01.Link01.Next,
                  "struct Linkage_Struct *", "node01.Link01.Next", node01.Link01.Next,
                  "struct Linkage_Struct", "& node01.Link02", 0);
  node01.Link02.Next = & node02.Link01;
  logAssignOffset("cell-sll.c", 38, & node01, "struct Weiss_SLL_Node", "node01", & node01.Link02.Next,
                  "struct Linkage_Struct *", "node01.Link02.Next", node01.Link02.Next,
                  "struct Linkage_Struct", "& node02.Link01", 0);
  node02.Link01.Next = & node02.Link02;
  logAssignOffset("cell-sll.c", 40, & node02, "struct Weiss_SLL_Node", "node02", & node02.Link01.Next,
                  "struct Linkage_Struct *", "node02.Link01.Next", node02.Link01.Next,
                  "struct Linkage_Struct", "& node02.Link02", 0);
  node02.Link02.Next = (LinkPtr )((void *)0);
  logAssignOffset("cell-sll.c", 42, & node02, "struct Weiss_SLL_Node", "node02", & node02.Link02.Next,
                  "struct Linkage_Struct *", "node02.Link02.Next", node02.Link02.Next,
                  "struct Linkage_Struct", "(LinkPtr )((void *)0)", 0);
  logBlockExit("cell-sll.c", 42);
  {
